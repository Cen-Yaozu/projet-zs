...
var _login = _interopRequireDefault(__webpack_require__(/*! ./pages/my/login.vue */ 60));
// @ts-ignore
...
/* harmony import */ var _login_vue_vue_type_template_id_ba7da882___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=ba7da882& */ 61);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 7;
                return _user.default.login(_this.loginForm);
              case 7:
                res = _context.sent;
                // 隐藏加载
                uni.hideLoading();
                if (res.code === 200) {
                  ...
                  uni.setStorageSync('userInfo', _objectSpread(_objectSpread({}, res.data.user), {}, {
                    role: _this.loginForm.role // 确保保存角色信息
                  }));

                  // 更新Vuex中的用户状态
                  _this.$store.commit('login', _objectSpread(_objectSpread({}, res.data.user), {}, {
